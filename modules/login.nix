  ...
  services.greetd = {
    ...
    settings = {
      default_session = {
        ...
        command = "${pkgs.greetd.tuigreet}/bin/tuigreet --background matrix --background-fps 30 --matrix-colors '#CCFFCC,#33FF66,#006622' --matrix-speed 9,16 --time --remember --asterisks --cmd start-hyprland wrapper";
